    ...
    <section className='py-20 md:my-24'>
      <div className='container'>
        ...
        <p className='text-white/70 text-lg md:text-xl text-center mt-5 tracking-tighter max-w-sm mx-auto'>
          Our revolutionary AI SEO tools have transfromed our clients&apos;
          strategies.
        </p>
            ...
            {[...testimonials, ...testimonials].map((testimonial) => (
              <div
                ...
                <div className='flex items-center gap-3 mt-5'>
                  <div className="relative after:content-[''] after:absolute after:bg-[rgb(140,69,244)] after:inset-0 after:mix-blend-soft-light after:rounded-lg before:content-[''] before:absolute before:inset-0 before:border before:border-white/30 before:z-10 before:rounded-lg">
                    <Image
